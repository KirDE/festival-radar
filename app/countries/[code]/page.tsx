...
export async function generateStaticParams(){const {festivals}=await getCatalog();return [...new Set(festivals.map((item)=>item.countryCode.toLowerCase()))].map((code)=>({code}));}
