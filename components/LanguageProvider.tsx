...
const translations = {
  en: {
    ...
    allFestivals: "All festivals", datesLineupTba: "Dates / lineup TBA", confirmedLineup: "confirmed lineup", partialLineup: "partial lineup", official: "Official", festivalWebsite: "Festival website ↗", passes: "Passes", officialTickets: "Official tickets ↗", ticketsInfo: "Tickets & info ↗", ticketsUnavailable: "Tickets not available", ticketsUnknown: "Availability not verified", listen: "Listen", artists: "artists", tracks: "tracks", spotifyPlaylist: "Spotify playlist ↗", playlistSoon: "Playlist coming soon", liveHistory: "Live history",
    ...
    festivalDirectory: "Festival directory", artist: "ARTIST", europeanFestival: "European festival", europeanFestivals: "European festivals", announcedFor: "announced for 2027", appearances: "2027 APPEARANCES",
  },
  de: {
    ...
    festivalDirectory: "Festival-Verzeichnis", artist: "KÜNSTLER", europeanFestival: "europäisches Festival", europeanFestivals: "europäische Festivals", announcedFor: "für 2027 angekündigt", appearances: "AUFTRITTE 2027",
  },
  ru: {
    ...
    festivalDirectory: "Каталог фестивалей", artist: "АРТИСТ", europeanFestival: "европейский фестиваль", europeanFestivals: "европейских фестивалей", announcedFor: "объявлено на 2027 год", appearances: "ВЫСТУПЛЕНИЯ В 2027",
  },
} as const;
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const setLanguage = (selected: Language) => { localStorage.setItem("festival-radar-language", selected); updateLanguage(selected); document.documentElement.lang = selected; };
