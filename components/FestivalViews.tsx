...
const POINTS: Record<string, [number, number]> = { AT:[57,61],BE:[42,45],CH:[48,64],CZ:[60,49],DE:[51,47],DK:[52,31],ES:[29,75],FI:[72,16],FR:[39,61],GB:[29,40],IT:[55,75],NL:[44,39],NO:[48,15],PL:[68,45],RO:[76,64],SE:[58,17],SI:[70,74] };
