...
export function SiteHeader() {
  const { t } = useLanguage();
  return <header className="siteHeader"><Link className="brand" href="/"><span className="brandMark">FR</span><span>Festival Radar</span></Link><nav><Link href="/">{t("festivals")}</Link><a href="https://github.com/KirDE/festival-radar">{t("aboutData")}</a></nav></header>;
}
